...
// ICRC-1 Reference Implementation
// Source: https://github.com/dfinity/ICRC-1/blob/main/ref/ICRC1.mo
...
type ApproveError = DeduplicationError or CommonError or {
  #Expired : { ledger_time : Nat64 };
  #AllowanceChanged : { current_allowance : Nat };
};

type TransferFromError = TransferError or {
